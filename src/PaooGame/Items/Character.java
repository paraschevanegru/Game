...
public abstract class Character extends Item {
   ...
   // protected boolean active = true;
    ...
    /*! \fn public void Move()
        \brief Modifica pozitia caracterului si verifica coliziunile cu obiecte.
     */
    public void Move() {

        if (!ItemCollision(xMove, 0f))
            ///Modifica pozitia caracterului pe axa X.
            MoveX();
        if (!ItemCollision(0f, yMove))
     ...
     */
    public void MoveX() {
        ///Aduna la pozitia curenta numarul de pixeli cu care trebuie sa se deplaseze pe axa .
        x += xMove;
    }
