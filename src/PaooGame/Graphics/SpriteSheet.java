...
public class SpriteSheet {
    ...
    /*! \fn public BufferedImage new_crop(int x, int y, int width, int height)
        \brief Returneaza un obiect BufferedImage ce contine o subimage (dala).

        \param x numarul dalei din sprite sheet pe axa x.
        \param y numarul dalei din sprite sheet pe axa y.
        \param width latimea dalei din sprite sheet.
        \param height inaltimea dalei din sprite sheet.

         */
    public BufferedImage new_crop(int x, int y, int width, int height) {
