...
public class Game implements Runnable
{
    ...
    private Graphics        g;          /*!< Referinta catre un context grafic.*/
        ...
        ///Available states
    public PlayState playState;            /*!< Referinta catre joc.*/
    ...
    public State gameOverState;            /*!< Referinta catre sfarsit joc.*/
    public State nextLevelState;           /*!< Referinta catre nivelul urmator.*/
    public State winState;                 /*!< Referinta catre castigare joc.*/
    ...
    private GameCamera gameCamera;         /*!< Referinta catre obiectul care gestioneaza game camera.*/
    private MyMouse myMouse;               /*!< Referinta catre obiectul care gestioneaza mouse-ul.*/
    ...
    private void InitGame()
    {
        ...
        wnd.GetWndFrame().addMouseListener(myMouse);
        wnd.GetWndFrame().addMouseMotionListener(myMouse);
        wnd.GetCanvas().addMouseListener(myMouse);
        wnd.GetCanvas().addMouseMotionListener(myMouse);
        ...
        refLink = new RefLinks(this);
            ///Se construieste obiectul de tip gameCamera ce va retine pozitiile de inceput.
        ...
        nextLevelState  = new NextLevelState(refLink);
    ...
    /*! \fn public MyMouse GetMYMouse()
        \brief Returneaza obiectul care gestioneaza mouse-ul.
     */
    public MyMouse GetMyMouse(){return myMouse;}

    /*! \fn public GameCamera GetGameCamera()
        \brief Returneaza obiectul care gestioneaza game camera.
     */
